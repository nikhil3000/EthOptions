...
const fs = require('fs');
const oracleAddress = '0x76082cCb24b8AA02424310306Ec237C7f57d1568';
...
module.exports = function (deployer, network, accounts) {
    ...
    return deployer.deploy(ERC721).then(() => {
        return deployer.deploy(EthOptionsFactory, ERC721.address, oracleAddress, { from: ownerAddress }).then(() => {
